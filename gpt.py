...
# displays the shape and contents of our input and target batches
# print('inputs:')
# print(xb.shape)
print(xb)
# print('targets:')
...
# Displays how we are using the context to predict the next character in the sequence
...
print(decode(m.generate(idx=torch.zeros(
    (1, 1), dtype=torch.long), max_new_tokens=500)[0].tolist()))
